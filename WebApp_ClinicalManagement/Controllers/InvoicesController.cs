...
namespace WebApp_ClinicalManagement.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InvoiceId,AppointmentDescription,Price,Vat,Name,IsPaid")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InvoiceId,AppointmentDescription,Price,Vat,Name,IsPaid")] Invoice invoice)
        {
